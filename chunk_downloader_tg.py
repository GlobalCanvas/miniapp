...
class ChunkDownloader:
                    ...
                    if resp.status == 200:
                        ...
                        for py in range(256):
                            for px in range(256):
                                idx = data[py * 256 + px]
                                if idx == 0:
                                    # Індекс 0 — порожня клітинка (прозора)
                        ...
                        # Порожній чанк — повертаємо прозорий
    ...
    async def download_area(self, canvas_size=None, x=0, y=0, w=256, h=256, palette=None, site_name=None, canvas_id=None):
        ...
        # RGBA щоб порожні клітинки були прозорими
                    ...
                    if img:
                        try:
                            ...
                            if crop_w > 0 and crop_h > 0:
                                ...
                                # Використовуємо alpha канал як маску щоб не затирати прозорі пікселі
