...
from minimap_module import upload_mini, upload_mini_handler, check_mini, get_mini, sitemini, UploadMiniStates
...
async def main():
    ...
    class AccessMiddleware(BaseMiddleware):
        async def __call__(
            ...
            # Дозволені команди без авторизації: /code і /start
            text = event.text or ""
            if text.startswith("/code") or text.startswith("/start"):
                return await handler(event, data)
